...
public class ExtractTemplateTest {
    private static void test1() {
        ...
        System.out.println(extractTemplate.getTemplate("各位嘉宾"));
    }
    ...
    private static void test2(String text) {
        ...
        System.out.println(extractTemplate.getTemplate(text));
        System.out.println(document.select(extractTemplate.getTemplate(text)).text());
    }
